# Best Practices & Style Guide For iOS
...
The recommended version of Xcode (and Swift) for all purposes is the current available [in the App Store](https://itunes.apple.com/app/xcode/id497799835?mt=12).
...
extension UIFont {
    class func bold(size: Double) -> UIFont {
        return UIFont(name: "Texta-Bold", size: CGFloat(size))!
    }

    class func light(size: Double) -> UIFont {
        return UIFont(name: "Texta-Light", size: CGFloat(size))!
    }

    class func medium(size: Double) -> UIFont {
        return UIFont(name: "Texta-Medium", size: CGFloat(size))!
    }

    class func regular(size: Double) -> UIFont {
        return UIFont(name: "Texta-Regular", size: CGFloat(size))!
    }
}
```
